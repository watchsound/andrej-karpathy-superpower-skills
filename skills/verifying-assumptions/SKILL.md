...
- **Re-anchor on intent.** Re-read the original task as your human partner phrased it. Ask: *"What higher-level goal does this assumption serve?"* Verify against that goal, not the assumption text. The assumption itself may have been the wrong question.
